...
class RalphLspServerDescriptor(project: Project)
    extends ProjectWideLspServerDescriptor(project, "Ralph") {

  // TODO: Use BuildInfo or an sbt setting to configure this automatically
  private val jar = "{project-path}/ralph-lsp/lsp-server/target/scala-2.13/ralph-lsp.jar"
